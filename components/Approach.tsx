...
const advantages = [
  {
    ...
    description:
      "Vos armoires et surfaces existantes sont conservées : le chantier reste propre et votre cuisine reste utilisable.",
  },
  {
    number: "02",
    title: "Précision dans chaque détail",
    description:
      "Des bordures nettes, des surfaces uniformes et une installation réalisée avec soin, du premier panneau au dernier.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    description:
      "Un accompagnement adapté à votre espace, à votre style et aux besoins de votre projet, partout dans la grande région de Montréal.",
  },
];
...
export default function Approach() {
  return (
    <section
      id="approach"
      className="ms-bg-cashmere px-4 py-24 sm:px-6 lg:px-10 lg:py-32"
    >
      <div className="mx-auto max-w-[1500px]">
        <Reveal>
          <div className="grid overflow-hidden rounded-[2rem] border border-neutral-300 bg-white lg:grid-cols-[1.05fr_0.95fr]">
            <div className="group relative min-h-[520px] overflow-hidden lg:min-h-[760px]">
              <Image
            ...
            <div className="flex flex-col justify-center px-7 py-14 sm:px-10 lg:px-14 lg:py-20 xl:px-16">
              ...
              <p className="mt-7 max-w-xl text-base leading-8 text-neutral-600 lg:text-lg">
                ...
                délais, les coûts et les contraintes d’une rénovation
                complète.
              </p>

              <div className="mt-9 border-t border-neutral-200">
                {advantages.map((advantage, index) => (
                  <Reveal key={advantage.number} delay={index * 90}>
                    <article className="grid grid-cols-[44px_1fr] gap-4 border-b border-neutral-200 py-5">
